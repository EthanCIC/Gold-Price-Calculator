document.getElementById('calculator').addEventListener('input', function(e) {
    ...
    document.getElementById('output1').innerText = '一公斤價格（美元）：' + output1.toFixed(2) + ' (USD/kg)';
    document.getElementById('output2').innerText = '一公斤價格（台幣）：' + output2.toFixed(2) + ' (TWD/kg)';
    document.getElementById('output3').innerText = '一台斤價格（台幣）：' + output3.toFixed(2) + ' (TWD/台斤)';
});
